...
<template>
    <nav class="nav" v-if="isLogin">
        <RouterLink to='/' class="navbar-element" active-class="custom-active-class">
            ...
            <h3 class = "nav-name">Dashboard</h3>
        </RouterLink>
        <div class="empty-space"></div>
        <RouterLink to='/company' class="navbar-element" active-class="custom-active-class">
            ...
            <h3 class = "nav-name">Company</h3>
        </RouterLink>
        <RouterLink to='/department' class="navbar-element" active-class="custom-active-class">
            <svg xmlns="http://www.ws3.org/2000/svg" height="30" width="30" viewBox="0 0 640 512">
                <path fill="#ffffff"
            ...
            <h3 class = "nav-name">Department</h3>
        </RouterLink>
        <RouterLink to='/user' class="navbar-element" active-class="custom-active-class">
            <svg xmlns="http://www.w3.org/2000/svg" height="30" width="30" viewBox="0 0 512 512">
                <path fill="#ffffff"
                    d="M399 384.2C376.9 345.8 335.4 320 288 320l-64 0c-47.4 0-88.9 25.8-111 64.2c35.2 39.2 86.2 63.8 143 63.8s107.8-24.7 143-63.8zM0 256a256 256 0 1 1 512 0A256 256 0 1 1 0 256zm256 16a72 72 0 1 0 0-144 72 72 0 1 0 0 144z" />
            </svg>
            <h3 class = "nav-name">Users</h3>
        </RouterLink>
        <RouterLink to='/equipment' class="navbar-element" active-class="custom-active-class">
            <svg xmlns="http://www.w3.org/2000/svg" height="30" width="30" viewBox="0 0 512 512">
                <path fill="#ffffff"
