    ...
    <div class="page-content">
        ...
        <div class="search-con" style="width: 20vw;">
            <multiselect class="search-input" id="userTag" v-model="searchUser"
                tag-placeholder="Add this as new tag" placeholder="Filter Users" label="name"
            ...
            <table>
                ...
                <tbody id="table_log">
                    <tr v-for="item in filteredData" :key="item.useruuid">
                        ...
                        <td class ="table-ele" v-if = "user.priv != null"> <input type="checkbox" :value=item.useruuid v-model="selectUser"></td>
                    </tr>
                </tbody>
            </table>
